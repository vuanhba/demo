...
<head>
    ...
    <title>Quản lý Shop Smart | Đăng nhập</title>
...
<div id="login-wrapper" class="png_bg">
    <div id="login-top">
        <h1>HỆ THỐNG QUẢN LÝ SHOP SMART</h1>
        <!-- Logo (221px width) -->
        <img id="logo" src="public/layout/resources/images/logo3.jpg" alt="Nhà Hàng Admin logo" />
    </div> <!-- End #logn-top -->
